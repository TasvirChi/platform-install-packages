DROP TABLE IF EXISTS `borhandw`.dwh_dim_client_tags;

CREATE TABLE `borhandw`.`dwh_dim_client_tags` (
...
CREATE TRIGGER `borhandw`.`dwh_dim_client_tags_setcreationtime_oninsert` BEFORE INSERT
