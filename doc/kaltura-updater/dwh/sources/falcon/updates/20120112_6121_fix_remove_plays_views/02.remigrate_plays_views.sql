...
BEGIN
    ...
    CLOSE c_partitions;
	 ...
	 UPDATE dwh_entry_plays_views p, dwh_entry_plays_views_old o
	 SET p.updated_at = o.updated_at
	 WHERE o.entry_id = p.entry_id;
END&&
...
DROP TABLE dwh_entry_plays_views_old;
