...
Version: v1.0.6 
Release: 2 
Summary: Borhan Video Presentations Manager
License: AGPLv3+	
URL: http://borhan.org
...
This package installs the Borhan Video Presentations Manager.
...
%changelog
* Mon Feb 3 2014 Jess Portnoy <jess.portnoy@borhan.com> - v1.0.6-2 
- Since these widgets typically reside on NFS and served from another machine there is not need for the Apache dep.

* Sun Jan 12 2014 Jess Portnoy <jess.portnoy@borhan.com> - v1.0.6-1
- initial package.
