...
if [ "$1" = 2 ];then
	if [ -r "%{prefix}/app/configurations/system.ini" -a -r %{prefix}/app/deployment/sql_updates ];then
		...
		# need to check if our current one is in the done list, if so, skip it.
			...
			if [ -r $SQL ];then
				mysql borhan -h $DB1_HOST -u $DB1_USER -P $DB1_PORT -p$DB1_PASS < $SQL 2>/dev/null
				RC=$?
			else
				echo "In order to upgrade your DB, please run %{prefix}/bin/borhan-db-update.sh once the RPMs installation completes."
				RC=1
			fi
		done
		if [ $RC -eq 0 ];then
...
%preun
find %{_sysconfdir}/logrotate.d -type l -name "borhan_*" -exec rm {} \;
...
%changelog
* Wed Jan 4 2017 jess.portnoy@borhan.com <Jess Portnoy> - 1.0.32-9
- Fetch DB3LITE as part of live-analytics-config.sh

* Tue Jan 3 2017 jess.portnoy@borhan.com <Jess Portnoy> - 1.0.32-8
- Additions to borhan-live-analytics-config.sh

* Mon Dec 12 2016 jess.portnoy@borhan.com <Jess Portnoy> - 1.0.32-6
...
* Tue Nov 29 2016 jess.portnoy@borhan.com <Jess Portnoy> - 1.0.32-1
- Added borhan-live-config.sh

* Tue Oct 4 2016 jess.portnoy@borhan.com <Jess Portnoy> - 1.0.31-27
...
* Thu Jun 30 2016 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.31-18
- Fixed sed in borhan-nginx-config.sh

* Tue May 31 2016 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.31-8
- Generate php5full and use them for partner_delete.php since the php5 client not longer contains systemPartner

* Sun Apr 17 2016 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.31-7
- Quote ENV_NAME
...
* Fri Feb 12 2016 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.31-1
...
* Wed Jan 27 2016 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.30-13
- Fix cache and log deletion.

* Thu Jan 21 2016 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.30-12
- Properly set PROTOCOL

* Tue Jan 12 2016 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.30-10
- Support Nginx SSL config

* Thu Dec 31 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.30-9
- Fix SSL config

* Sun Dec 13 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.30-8
- Verify that studio_version in {base,local}.ini matches the latest studio version on disk.

* Fri Dec 11 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.30-6
...
* Tue Nov 24 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.30-3
- Do not attempt to create the borhan and etl DB users if they already exist.

* Fri Nov 20 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.30-2
- Use 100 bytes instead of 20 when generating the partner secrets.

* Wed Nov 18 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.30-1
- Output failure message in trap handler.

* Mon Nov 16 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.29-16
- Set SPHINX_SERVER2 to localhost if not specified.

* Mon Nov 9 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.29-14
- Added Community survey URL to welcome message
- Corrected other URLs to be over HTTPs

* Thu Nov 5 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.29-13
...
* Thu Oct 29 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.29-12
- Actually 600 is hardly good since apache and borhan users need to read many of these files.
Set proper ownership and permissions on sensitive files instead.

* Thu Oct 29 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.29-11
...
* Wed Oct 28 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.29-10
- Added -f to curl command testing connectivity to $SERVICE_URL.

* Wed Oct 21 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.29-5
- when cleaning cache, only remove files, not dirs.

* Wed Oct 21 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.29-4
- Typo: SPHINX_SERVER should be SPHINX_SERVER1.

* Mon Oct 19 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.29-3
- Replace @INSTALLED_HOSTNAME@ token for populate monit config
- Symlink sphinx logrotate config to /etc/logrotate.d/

* Wed Oct 14 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.29-2
...
* Mon Oct 12 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.29-1
- Check mysql connectivity during base-config and exit on failure.

* Wed Oct 7 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.28-19
- if a CA cert was provided, use -CAfile when execing openssl verify.

* Thu Oct 1 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.28-18
...
* Mon Sep 14 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.28-11
...
* Thu Jul 16 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.28-2
- notifications tests: delete() in the end of test.

* Thu Jul 16 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.28-1
- dropfolder test: delete() afterwards.

* Tue Jul 14 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.27-16
- In RHEL/CentOS 7 - memcached is not started and set to init by its RPM postinst script, do it in ours.

* Tue Jul 14 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.27-15
- for RHEL7, package is called nfs-utils not nfs-utils-libs

* Fri Jul 10 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.27-14
- Changed script name to match script naming convention.

* Fri Jul 10 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.27-11
- Added script that clears old dwh logs, runs the logrotate and then all the jobs from /etc/cron.d/borhan-dwh.. Useful for when debugging analytics.

* Thu Jul 9 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.27-10
...
* Wed Jul 8 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.27-3
- Added upload captions test 
- Added search entry test
- Added notification tests

* Fri Jun 19 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.26-5
...
- Added script for borhan-play-server

* Thu May 21 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.26-1
...
* Tue May 5 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.25-11
- Reinstated clipping checks.

* Mon May 4 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.25-10
- Disable trimming and clipping tests as they stopped working since 10.9.0.

* Mon Apr 13 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.25-3
- Modifications to allow sanity to run on both RPM and deb based systsms.

* Mon Apr 6 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.25-2
- Use example.com for test partner. example.com is ignored by MTAs.

* Fri Apr 3 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.24-12
- Remove logrotate syms during preun.

* Thu Apr 2 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.24-11
- Added script to clean all data from the DWH DBs. Useful for when you want to keep the operational 'borhan' DB but clear analytics.

* Tue Mar 17 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.24-9
- corrected clipapp sanity check.

* Sun Mar 15 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.24-8
- Symlink Borhan vhost config to apache conf.d when installing batch.

* Sat Mar 14 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.24-7
- added limit 1 to select conf_file_path from ui_conf where tags like '%bmc_uploadWebCam%' LIMIT 1; 
  reported by Kinglok, Fong - thank you.

* Sat Feb 28 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.24-6
- instead of chmoding in cache dir just get rid of it.

* Sat Feb 28 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.24-5
- push WWW_HOST var to ans file.

* Sat Feb 28 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.24-4
- Added test for clipapp url.

* Wed Feb 18 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.24-1
- Added BPM deploy script.

* Wed Jan 14 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.23-2
- Modifications to support VOD packager.

* Sun Jan 11 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.22-10
- Direct STDERR to /dev/null when rpm -q.

* Fri Jan 9 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.22-9
- Added create and remove flavor tests.

* Sun Jan 4 2015 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.22-4
- Support mariadb in borhan-mysql-settings.sh
...
* Mon Nov 24 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.21-8
...
* Wed Nov 12 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.21-3
- Added validation for timezone value.

* Mon Nov 10 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.21-2
- Added script to handle the event of Sphinx being added a column

* Tue Nov 4 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.21-1
- Installytics moved to MySQL so curl call for reporting changed some
- Added subscribed_for_ce_updates to the report

* Mon Nov 3 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.20-10
- Try to use dmidecode to generate uniq machine ID, if it exists..

* Thu Oct 30 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.20-9
- Fixes for Analytics.

* Mon Oct 27 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.20-8
- Added reconversion of entry to sanity.

* Sun Oct 26 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.20-6
- Call for Marketo takes a few sec to complete - added a message.

* Sun Oct 26 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.20-5
- Prompt about Community newsletter

* Fri Oct 24 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.20-4
- Only run studio test if borhan-html5lib is installed

* Thu Oct 23 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.20-3
- Redirect ls' STDERR to /dev/null when looking for java
- Added test for studio's index.html to borhan-sanity.sh

* Sun Oct 19 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.20-2
- Correct /dev/null redirection.

* Thu Oct 9 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.19-4
- Better distro detection for analytics.

* Mon Oct 6 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.19-2
- redirect ls STDERR to dev/null
- fix analytics.

* Sun Sep 21 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.19-1
...
* Wed Aug 13 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.17-14
- With storage creation script.

* Mon Aug 11 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.17-10
- With thumb testing..

* Mon Aug 11 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.17-5
- Added dropfolder creation test.

* Sun Aug 10 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.17-4
- Added tests to sanity:
  - clipping
  - trimming
  - mail sending post partner creation

* Tue Aug 5 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.17-1
- Starting support of alt port for Apache and CDN.

* Tue Jul 15 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.16-5
- Fixes for making the install work when MySQL is on alt port.

* Thu  Jul 10 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.16-4
- ls on the BMC dir may fail because this is running on Sphinx which needs no web mount so redirect STDERR to /dev/null

* Mon Jul 2 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.16-3
- BMC SWF tests added.

* Mon Jun 30  2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.16-1
- Added playManifest and download test to san.

* Wed Jun 25 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.15-4
- Added new token replacement for TEMPLATE_PARTNER_ADMIN_PASSWORD

* Tue Jun 24 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.15-2
-  -6 partner token replacement.

* Tue Jun 24 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.15-1
- need to replace WWW_HOST in the DB create scripts too

* Tue Jun 10 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.14-5
- Fixed streams dir and symlink check.

* Tue Jun 10 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.14-4
...
* Sun Jun 1 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.14-1
- Offering 'root' as default does little good if we don't accept it and looping with prompt.

* Thu May 22 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.13-8
- F typo. 
- Added call for contributors banner.

* Wed May 21 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.13-4
...
* Sun May 4 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.12-28
- Better output.

* Tue Apr 29 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.12-23
- need unzip for the sanity test.

* Tue Apr 29 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.12-22
...
* Sat Apr 26 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.12-5
- No reason to require root previleges for running the alters. 'borhan' user is capable of it.

* Sun Apr 20 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.11-18
- Added dwh and delete partner to sanity testing.

* Sat Apr 19 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.11-2
- In borhan-front-config.sh - first call borhan-base-config.sh

* Thu Apr 17 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.11-1
- Bugs->fixes.

* Wed Apr 9 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.10-8
- Need to respect USER_CONSENT coming from the ans file.

* Tue Apr 8 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.10-7
- Added bc to deps. Used in borhan-sanity.sh

* Tue Apr 8 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.10-2
- Check if borhan-base is installed before starting config proc.

* Wed Mar 26 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.9-8
- replace html5_version in base.ini to latest.

* Wed Mar 26 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.9-7
- The creation of ans file should be called later on.

* Wed Mar 26 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.9-6
- Script to setup MySQL replication added.

* Tue Mar 25 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.9-2
- To match Core release 9.13.0.

* Sun Mar 23 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.9-1
- borhan-sanity.sh's output revised according to Zohar's requests.

* Sat Mar 22 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.8-19
- borhan-sanity.sh is operational.

* Thu Mar 20 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.8-18
- borhan-front-config.sh - we can't use rpm -q borhan-bmc because this node may not be the one where we installed the BMC RPM on, as it resides in the web dir and does not need to be installed on all front nodes.

* Thu Mar 20 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.8-16
- disable ERR trap when checking if borhandw tables exist.

* Mon Mar 17 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.8-11
- Colors && shit..

* Mon Mar 17 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.8-10
- Color corrections
- Do not sed on php INIs where they are not present [DWH, Sphinx].
- Suggest to drop the DB if it exists and db-config is run.

* Mon Mar 17 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.8-7
- Colorful output to make err detection easy.

* Thu Mar 13 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.8-3
- Random monit passwd.

* Thu Mar 13 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.8-2
- Modified message in drop-db.sh

* Thu Mar 13 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.8-1
- Modified mail template a little.
- Added script to configure NFS client side.

* Tue Mar 9 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.7-23
- '"' around CONSENT.

* Wed Mar 5 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.7-22
...
* Sat Mar 1 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.7-19
...
* Wed Feb 25 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.7-9
...
* Tue Feb 24 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.7-8
- Added version and revision info to beacons.

* Wed Feb 24 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.7-7
- /app/deployment/sql_updates should be in this package and not in base, since it is being used here.

* Tue Feb 24 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.7-2
- typo

* Tue Feb 24 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.7-1
- Becons modifications.
- User consent msg added.

* Mon Feb 24 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.6-8
- If this is an upgrade and DB connectivity works - generate UI confs.

* Sun Feb 23 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.6-2
- monit's init show failure when attempting to stop a monit that isn't running.
  Direct to /dev/null in that case.

* Sat Feb 22 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.6-1
- Post becon tests.

* Sat Feb 22 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.5-34
- Becon corrections.

* Fri Feb 21 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.5-30
- With becons.

* Thu Feb 20 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.5-29
- Only add studio.template.ini to CONF_FILES if html5-studio is installed.

* Tue Feb 18 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.5-26
...
* Sun Feb 16 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.5-19
- Attempt to correct corrupted UI confs.

* Sun Feb 16 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.5-18
- Need to restart monit daemon after each daemon config, can't do it in all because not every inst. is all in 1.

* Sun Feb 16 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.5-14
- chown and chmod monit.conf to be root.root 600.

* Sat Feb 15 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.5-13
- Monit fixes.

* Fri Feb 14 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.5-11
- chown apache for the streams dir.

* Fri Feb 14 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.5-8
- Replace localhost with actual server name in oflaDemo/index.html
* Fri Feb 14 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.5-6
- Some fixes for Red5.

* Fri Feb 14 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.5-5
- Added Red5 config script.

* Thu Feb 13 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.5-4
- Symlink to red5 streaming dir.

* Thu Feb 13 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.5-3
- Prompt for RED5 host.

* Thu Feb 13 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.5-2
...
* Wed Feb 5 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.4-10
- Correctly replace timezone directive
- Easier copy paste output for MySQL directives

* Wed Feb 5 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.4-8
- typo fix.

* Wed Feb 5 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.4-7
- Passwd confirmation prompt
- Changed string 'host' to 'hostname'

* Mon Feb 3 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.4-3
- Exit configs if the relevant RPM package isn't installed.

* Mon Feb 3 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.3-11
Replace tokens in %%{prefix}/app/tests/monitoring/config.template.ini

* Mon Feb 3 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.3-10
- Don't attempt to replace tokens for DWH if DWH isn't installed on node.

* Mon Feb 3 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.3-9
- Fixes for cluster install.

* Sun Feb 2 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.3-7
- Auto detect TZ.

* Sat Feb 1 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.3-5
- Phrasing correction.

* Sat Feb 1 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.3-4
- Minor corrections to db-config.

* Wed Jan 29 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.2-8
- Modified post install mail template.

* Tue Jan 28 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.2-7
- With post install mail template.
* Tue Jan 28 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.2-8
- Now actually USE the templ to send it out.

* Tue Jan 28 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.2-7
- With post install mail template.

* Tue Jan 28 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.2-6
- Proper Analytics population msg.
- Change all server prompt defaults to 127.0.0.1.
- Changed inst complete msg.

* Tue Jan 28 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.2-5
- bash -x on drop-db.sh

* Mon Jan 27 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.2-3
- Removed debug from front.
- Added DWH config to config-all.sh

* Mon Jan 27 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.2-1
- New minor release.

* Sat Jan 25 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.0-38
...
- Added %%prefix/bin/borhan-drop-db.sh
- Added %%prefix/borhan-mysql-settings.sh

* Sun Jan 19 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.0-15
- Version bounce. 

* Thu Jan 16 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.0-13
- Only run base-config if there's no lock indicating it already ran.

* Tue Jan 14 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.0-12
- Additions to both base and db config scripts.

* Tue Jan 14 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.0-11
- Added DB config script and RC file.

* Thu Jan 9 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.0-4
- Bounce.

* Thu Jan 9 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.0-2
- Updated base config script.

* Mon Jan 6 2014 Jess Portnoy <jess.portnoy@borhan.com> - 1.0.0-1
- initial package. 
