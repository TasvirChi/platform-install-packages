...
This package installs the fallback BDP Flash player.
Please note that in normal situations, the BDP3 package will be used.
...
%install
mkdir -p $RPM_BUILD_ROOT%{prefix}/web/flash/bdp
cp -r %{_builddir}/%{name}/%{version} $RPM_BUILD_ROOT/%{prefix}/web/flash/bdp/
...
%files
%defattr(-,root,root,-)
%{prefix}/web/flash/bdp


%changelog
* Mon Feb 3 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.7.0-2
- Since these widgets typically reside on NFS and served from another machine there is not need for the Apache dep.

* Sun Jan 12 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.7.0-1
- initial package.
