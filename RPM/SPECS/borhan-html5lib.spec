...
Source4: borhan-html5lib-v2.37.1.tar.gz
Source5: borhan-html5lib-v2.38.3.tar.gz
Source6: borhan-html5lib-v2.42.tar.gz
Source7: borhan-html5lib-v2.44.tar.gz
Source8: borhan-html5lib-v2.45.tar.gz
...
This package installs the Borhan HTML5 library.
...
find /opt/borhan/web/html5/html5lib -type d -name cache -exec chown -R 48 {} \; 
...
%config %{prefix}/web/html5/html5lib/%{version}/LocalSettings.BorhanPlatform.php

%changelog
* Mon Dec 19 2016 Jess Portnoy <jess.portnoy@borhan.com> - v2.51-1
...
* Tue Nov 22 2016 Jess Portnoy <jess.portnoy@borhan.com> - v2.50-1
...
- Send raw borhan plugin data to chrome cast
- SUP-9527 - Player info plugin displaying number of impressions instead of number of plays
- SUP-9648 - Issue is in udrm in IE
- FEC-6242 - Silver light error msg on Edge browser - Player is not uploaded
- FEC-6245 - DFP pre-roll with skip: "Skip Ad" button displayed twice,if click on Ad
...
* Thu Nov 3 2016 Jess Portnoy <jess.portnoy@borhan.com> - v2.49-1
...
- Select base, main and high profiles when forcing using "Borhan.ForceHighResFlavors"
- peer5 plugin update
...
* Mon Sep 26 2016 Jess Portnoy <jess.portnoy@borhan.com> - v2.48.1-1
...
* Fri Sep 23 2016 Jess Portnoy <jess.portnoy@borhan.com> - v2.48-1
...
- FEC-6047 - Borhan Live with Vast : Pre Roll ad and video is not getting played on Android
...
- FEC-6106 - MPEG_Dash: Playlist: Video stuck with loading spinner after performing seek before tapping on play (occurs only with debugBorhanPlayer)
- FEC-6027 - MPEG_Dash: Playlist: Second video stuck after whole playlist and first video (one more time) finished to play(IE11 only)
...
* Wed Sep 7 2016 Jess Portnoy <jess.portnoy@borhan.com> - v2.47-2
- Auto upgrade players ui conf to the latest version upon each upgrade

* Tue Sep 6 2016 David Bezemer <david.bezemer@borhan.com> - v2.47-2
- remove obsolete old player versions
- add missing player versions

* Mon Sep 5 2016 Jess Portnoy <jess.portnoy@borhan.com> - v2.47-1
- FEC-5898 - Set hls.js to be on by default
...
* Tue Aug 2 2016 Jess Portnoy <jess.portnoy@borhan.com> - v2.46-1
...
- FEC-5852 - Regression:Borhan Live with DVR: DVR scrubber is shown at left side of a player on MS edge instead of right
- Chromecast ui/x
...
* Tue Jul 19 2016 Jess Portnoy <jess.portnoy@borhan.com> - v2.45.1-1
- FEC-5792 - Mobile skin - Regression - captions is shown in both smart containers
- FEC-5792 - Mobile skin - Regression - captions is shown in both smart containers
- FEC-5791 - Mobile skin - custom style - plugin's name in smart container
- FEC-5790 - Mobile skin - Custom spinner is not shown on mobiles
...
* Tue Jul 5 2016 Jess Portnoy <jess.portnoy@borhan.com> - v2.45-1
...
- FEC-5689 - Playlist with watermark - Tapping on the watermark does not open Borhan site in a new tab
...
* Fri Jun 3 2016 Jess Portnoy <jess.portnoy@borhan.com> - v2.44-1
...
- FEM-460 - Handle Borhan.OverrideLicneseURL in MobileSDK/EmbedPlayerNativeComponent
- FEC-484 - Version Tag
- FEC-5457 - expose new event for external full screen
- FEC-5395 - hlsjs- heartbeat: trackSessionStart event not reported when playing borhan live with dvr
...
- FEC-5573 - Add ‘ setBDPAttribute’ support for ‘visible’ property in controlBarContainer and topBarContainer
...
- Add captions force webVTT flag for borhan API on-the-fly generated webvtt captions

* Sun May 8 2016 Jess Portnoy <jess.portnoy@borhan.com> - v2.43-1
...
- SUP-7693 - Typo in BMC studio Enable embed.ly embeds
...
- SUP-7729 - Frames of Borhan Secret protected videos are visible to unauthenticated user
...
* Sun Apr 10 2016 Jess Portnoy <jess.portnoy@borhan.com> - v2.42-1
...
- FEC-5189 - HLSjs: Borhan Live: Off air appears when live is playing
- FEC-5187 - HLSjs: Borhan Live: Play after pause is not working
- FEC-5186 - HLSjs: Borhan Live with DVR is not playing smothly
...
- FEC-5190 - borhan stats: play event is not fired for the second and third entry in a playlist with flash dfp
...
- new HLS-OSMF plugin
* Fri Mar 11 2016 Jess Portnoy <jess.portnoy@borhan.com> - v2.41-1
- FEC-4777 - Updated DVR Layout for Player
...
* Sun Feb 14 2016 Jess Portnoy <jess.portnoy@borhan.com> - v2.40-1
...
- FEC-4580 - Enhanced Advertising > Content playback flow for web
- FEC-4541 - update API documentation in player.borhan.com documentation
...
* Sun Jan 17 2016 Jess Portnoy <jess.portnoy@borhan.com> - v2.39-1
...
- FEC-4456 - HLS OSMF - the spinner appears during DVR playing if to stop and re-run Borhan stream
- FEC-4459 - HLS OSMF - take around 10-12 seconds to switch from DVR to Borhan Live
- FEC-4462 - HLS OSMF - Seek in Borhan DVR take more time than in previous player version
- FEC-4458 - HLS OSMF - Borhan Live with DVR loaded with 40-50 seconds of delay
- FEC-4567 - Regression: Borhan Live without DVR stuck at beginning for 10-15 second
- WEBC-632 - Use the creation time for answer-on-air instead of relative time
- FEC-4460 - HLS OSMF - the Borhan live's time isn't synchronized with the timer - 1 minute difference
- FEC-4457 - HLS OSMF - After Borhan Live stopped, the DVR started from 1 minute
- FEC-4452 - HLS OSMF - the DVR timer of the Borhan live stopped to update after several seconds
- FEC-4451 - HLS OSMF - the timer for Borhan live isn't updated
...
- FEC-4594 - HLS OSMF - Borhan Live without DVR and VOD periodically stuck for 2-3 seconds during throttling
...
- SUP-6773 - Borhan player v2.36.2 - live stream with pre-roll ads mixed audio
...
* Mon Dec 21 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.38.1-1
- TR-552 - CaaS widgets with playlist - On iOS thumbnail is out of alignment
...
* Sat Dec 19 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.38-1
...
- FEC-4519 - Borhan Live isn't starting to play after stop and re-run the stream
...
- BorhanHLS2 plugin removed

* Fri Dec 4 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.37.3-1
- FEC-4446 - Fix issue with playback engine fail resolving URL redirect(HTTP 302)

* Sun Nov 22 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.37.1-2
- Remove unneeded and yet very big modules/Widevine dir while packaging.

* Fri Nov 20 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.37.1-1
- FEC-2823 - Google Analytics configuration in Studio is wrong
- FEC-3724 - uDRM: Modular DRM p2 is not working on IE11 & Edge
- FEC-3937 - Player Share is hardcoded to cdnapi.borhan.com
...
- PLAT-3590 - Replace existing og:tags in BMC Preview & Embed links to support HTML5 playback on Facebook and Embedly
- Remove unneeded and yet very big modules/Widevine dir while packaging.
...
* Thu Oct 22 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.36-1
...
- FEC-4162 - Channel playlist - playlist button look disabled in live event that had not start
- FEC-4151 - v2.35 Error: Using non-prodcution version of borhan player library.
- FEC-4179 - airPlay plugin doesn't work
- FEC-4080 - Borhan Live with DVR through HLS failed to be load
...
* Thu Oct 8 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.35.5-1
- IVQ release

* Thu Sep 17 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.35-1
...
- FEC-2522 - Support DFP VAST VPAID engine: Borhan cuePoints, API invocation and partial mediaProxy cuePoint override
...
- FEC-4096 - YouTube playlist: the playlist doesn't load if delivery type is Borhan auto or HDS
...
- FEC-4099 - Youtube and BMC playlist: impossible to change playing entry from YouTube to BMC or vice versa on Android and iOS
...
- FEC-4093 - Lecture Capture: the LC menu/controls appear also for Borhan live entries in combined playlist
...
* Tue Sep 15 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.34-3
- Create cache dir under web/html5/html5lib/$i/cache and set write perms for Apache
- Symlink LocalSettings.php to /opt/borhan/app/configurations/html5.php
- borhan-html5lib depends on kConf.php provided by borhan-base so a Requires: borhan-base is needed

* Thu Aug 20 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.34-1
...
* Fri Jul 24 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.33-1
...
- FEC-2900 - Implement embedly player.js interface for player API against borhan player
...
* Sun Jul 12 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.32.1-1
- Support MSE/EME only on Chrome

* Sun Jun 28 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.32-1
...
- SUP-3568 - Change Iframe title from "Borhan Embed Player iFrame" to the player's title
...
* Sun May 31 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.31-1
...
* Mon May 4 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.30-1
...
* Sun Apr 5 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.29-1
...
- SUP-3684 - Thumbnail at the end of a live stream
- SUP-4189 - Borhan Player versions greater than 2.22 don't handle onTextData event data properly - Kaplan
...
- SUP-3960 - Ad tag issue - BDP

* Sun Mar 8 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.28-1
...
- SUP-3783 - Player and BMC not showing all the captions available
...
- SUP-3781 - Captions supported in BDP does not in HTML5
- SUP-3629 - Postmedia No playerPlayed event after prerolls and before contnet with DFP ads
- SUP-3340 - Live stream freezes for a few seconds when streaming with KRecord

* Sun Feb 8 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.27-1
...
* Sun Jan 25 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.26-1
- SUP-3609 - Misplaced playback on iPad with 2.24 & 2.25
- FEC-2611 - Chapters/Slides Menu (revised) - Playback

* Sun Jan 11 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.25-1
- FEC-2611 - Chapters/Slides Menu (revised) - Playback
...
* Sun Jan 4 2015 Jess Portnoy <jess.portnoy@borhan.com> - v2.24-2
- Neglected to include v2.21 v2.22 v2.23
- Use a for loop to iterate on vers.

* Sun Dec 28 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.24-1
...
* Sun Dec 14 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.23-1
...
* Mon Dec 1 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.22-1
...
* Mon Nov 17 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.21-1
...
* Sun Nov 2 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.20-1
...
* Sun Sep 21 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.18.5-1
- ver bounce.

* Sun Aug 3 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.15-1
...
- FEC-1249 - BDP event mapping had mapping to non-existant html5 player events

* Thu Jul 10 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.14-1
...
* Sat Jun 14 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.11-1
...
* Thu May 22 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.9-2
- Add repo URL to metadata.

* Wed May 21 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.9-1
...
* Thu Apr 24 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.7-1
...
- FEC-1172 - BDP API should remain active during ad playback
...
* Sun Apr 6 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.6-1
...
* Sun Mar 30 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.5-6
- Copy the LocalSettings.php to all packaged HTML5 vers.

* Tue Mar 25 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.5-1
...
- SUP-1580 - Borhan colored loading wheel showing up instead of custom (IE 8, 9, 10)
- SUP-1717 - share plugin - social networks configurations 
- SUP-1720 - V2 player - Loop uiVar get stuck

* Sun Mar 9 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.4-1
...
* Sun Feb 23 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.3-1
  Fixes:
  - Studio V2 support
...
* Wed Jan 15 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.1.1-3
- Moved root dir to %{prefix}/web.

* Tue Jan 14 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.1.1-2
- Added %%doc.

* Tue Jan 14 2014 Jess Portnoy <jess.portnoy@borhan.com> - v2.1.1-1
- initial package.
