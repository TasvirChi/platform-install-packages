...
$partnerId=0;
$service_url= $argv[2];
$client=generate_ks($service_url,$partnerId,$secret,$type=BorhanSessionType::ADMIN,$userId=null,$expiry = null,$privileges = null);
$flavor_name='Flavor test II';
$filter = new BorhanFlavorParamsFilter();
$filter->systemNameEqual = $flavor_name;
$filter->formatEqual = BorhanContainerFormat::MP4;
...
if(!count($results->objects)){
	...
	$flavorParams->videoCodec = BorhanVideoCodec::H264M;
	$flavorParams->videoBitrate = 900;
	$flavorParams->audioCodec = BorhanAudioCodec::AAC;
	...
	$flavorParams->format = BorhanContainerFormat::MP4;
